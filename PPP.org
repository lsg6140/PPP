...
//-----------------------------------------------------------------------------
   ...
   #+begin_src C++ :main no :tangle calculator/ts_test.cpp :noweb yes
     #include "../std_lib_facilities.h"
   ...
   #+begin_src C++ :main no :tangle calculator/expr_test.cpp :noweb yes
     #include "../std_lib_facilities.h"
